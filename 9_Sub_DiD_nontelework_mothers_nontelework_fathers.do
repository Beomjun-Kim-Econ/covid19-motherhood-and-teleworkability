*******************************************************
* 9_Sub_DiD_nontelework_mothers_nontelework_fathers.do
*
* 보조 분석
* 2019년 비재택 직종에서 일한 어머니와 아버지를 비교한다.
*
* 모든 표와 그림의 결과변수 순서
* 1. 로그 시간당 임금
* 2. 로그 주당 근로시간
...
capture mkdir "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers"

* 이전 형식으로 만든 산출물이 남아 있으면 삭제한다.
capture erase "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_02_hours_event_study.rtf"
capture erase "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_03_hours_event_study.png"
capture erase "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_04_hours_did.rtf"
capture erase "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_05_hours_did.png"
capture erase "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_nonremote_parent_baseline_2019.dta"
...
* 부모 여부, 성별, 직종, 산업, 지역, 가중치를 2019년에 고정한다.
preserve
    keep if survey_year == 2019
    keep if if_child == 1
    keep if if_remote_possible == 0
    ...
    save "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_baseline_2019.dta", replace
restore

merge m:1 pid using ///
    "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_baseline_2019.dta", ///
    keep(3) nogen
...
capture log close
log using "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_01_tests.log", ///
    text replace
...
* 비교대상 1: 2019년 비재택 직종에서 일한 어머니
* 비교대상 2: 2019년 비재택 직종에서 일한 아버지
...
estimates store S_F9_hourly_event_u
...
reghdfe ln_hourly_wage i.mother2019##ib2019.survey_year ///
    ...
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hourly_event_w
...
reghdfe ln_hours i.mother2019##ib2019.survey_year, ///
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hours_event_u
...
reghdfe ln_hours i.mother2019##ib2019.survey_year ///
    ...
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hours_event_w
...
reghdfe ln_weekly_income i.mother2019##ib2019.survey_year, ///
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_weekly_event_u
...
reghdfe ln_weekly_income i.mother2019##ib2019.survey_year ///
    ...
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_weekly_event_w
...
esttab S_F9_hourly_event_u S_F9_hourly_event_w ///
    S_F9_hours_event_u S_F9_hours_event_w ///
    S_F9_weekly_event_u S_F9_weekly_event_w ///
    using "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_02_event_study.rtf", ///
    ...
    mtitles("시간당 임금 비가중" "시간당 임금 가중" ///
        "근로시간 비가중" "근로시간 가중" ///
        "주간소득 비가중" "주간소득 가중") ///
    title("보조 분석: 비재택 부모의 어머니-아버지 event study")

* 시간당 임금 event study 그림
coefplot ///
    (S_F9_hourly_event_u, label("비가중")) ///
    (S_F9_hourly_event_w, label("가중")), ///
    ...
    ytitle("어머니-아버지 로그 시간당 임금 변화 차이") ///
    xtitle("조사연도") ///
    title("비재택 부모의 시간당 임금 event study") ///
    note("기준연도: 2019년") legend(rows(1))

graph export ///
    "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_03_hourly_wage_event_study.png", ///
    width(2000) replace

* 근로시간 event study 그림
coefplot ///
    (S_F9_hours_event_u, label("비가중")) ///
    (S_F9_hours_event_w, label("가중")), ///
    keep(1.mother2019#*.survey_year) vertical ///
    yline(0, lcolor(gs8)) xline(3.5, lpattern(dash) lcolor(gs8)) ///
    coeflabels( ///
        1.mother2019#2016.survey_year = "2016" ///
        ...
        1.mother2019#2021.survey_year = "2021" ///
        1.mother2019#2022.survey_year = "2022") ///
    ytitle("어머니-아버지 로그 근로시간 변화 차이") ///
    xtitle("조사연도") ///
    title("비재택 부모의 근로시간 event study") ///
    note("기준연도: 2019년") legend(rows(1))

graph export ///
    "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_04_hours_event_study.png", ///
    width(2000) replace

* 주간 근로소득 event study 그림
coefplot ///
    (S_F9_weekly_event_u, label("비가중")) ///
    (S_F9_weekly_event_w, label("가중")), ///
    keep(1.mother2019#*.survey_year) vertical ///
    yline(0, lcolor(gs8)) xline(3.5, lpattern(dash) lcolor(gs8)) ///
    coeflabels( ///
        1.mother2019#2016.survey_year = "2016" ///
        ...
        1.mother2019#2021.survey_year = "2021" ///
        1.mother2019#2022.survey_year = "2022") ///
    ytitle("어머니-아버지 로그 주간소득 변화 차이") ///
    xtitle("조사연도") ///
    title("비재택 부모의 주간소득 event study") ///
    note("기준연도: 2019년") legend(rows(1))

graph export ///
    "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_05_weekly_income_event_study.png", ///
    width(2000) replace
...
reghdfe ln_hourly_wage i.mother2019##i.post2021_2022 ///
    ...
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hourly_did_u

reghdfe ln_hourly_wage i.mother2019##i.post2021_2022 ///
    if !missing(post2021_2022) [pw=person_wgt2019], ///
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hourly_did_w
...
reghdfe ln_hours i.mother2019##i.post2021_2022 ///
    ...
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hours_did_u

reghdfe ln_hours i.mother2019##i.post2021_2022 ///
    if !missing(post2021_2022) [pw=person_wgt2019], ///
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_hours_did_w
...
reghdfe ln_weekly_income i.mother2019##i.post2021_2022 ///
    ...
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_weekly_did_u

reghdfe ln_weekly_income i.mother2019##i.post2021_2022 ///
    if !missing(post2021_2022) [pw=person_wgt2019], ///
    absorb(pid survey_year occ2019#survey_year ind2019#survey_year ///
        region2019#survey_year) vce(cluster pid)
estimates store S_F9_weekly_did_w

esttab S_F9_hourly_did_u S_F9_hourly_did_w ///
    S_F9_hours_did_u S_F9_hours_did_w ///
    S_F9_weekly_did_u S_F9_weekly_did_w ///
    using "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_06_did.rtf", ///
    replace se star(* 0.10 ** 0.05 *** 0.01) ///
    ...
    mtitles("시간당 임금 비가중" "시간당 임금 가중" ///
        "근로시간 비가중" "근로시간 가중" ///
        "주간소득 비가중" "주간소득 가중") ///
    title("보조 분석: 비재택 부모의 어머니-아버지 평균 DiD")

coefplot ///
    (S_F9_hourly_did_u, label("시간당 임금 비가중")) ///
    (S_F9_hourly_did_w, label("시간당 임금 가중")) ///
    (S_F9_hours_did_u, label("근로시간 비가중")) ///
    (S_F9_hours_did_w, label("근로시간 가중")) ///
    (S_F9_weekly_did_u, label("주간소득 비가중")) ///
    (S_F9_weekly_did_w, label("주간소득 가중")), ///
    keep(1.mother2019#1.post2021_2022) ///
    coeflabels(1.mother2019#1.post2021_2022 = "어머니 × 사후기간") ///
    xline(0, lcolor(gs8)) ///
    title("비재택 부모의 어머니-아버지 평균 DiD") ///
    subtitle("2016-2019년 대비 2021-2022년") ///
    xtitle("어머니의 상대적 변화") legend(rows(2))

graph export ///
    "output/S_F9_Sub_DiD_nontelework_mothers_nontelework_fathers/S_F9_07_did_coefficients.png", ///
    width(2000) replace

log close
display as result "S_F9 보조 분석이 완성되었습니다."
